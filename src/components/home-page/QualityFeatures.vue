<template>
  <div class="quality-features my-8 py-8" style="background-color: #e1e1e1">
    <v-container fluid>
      <v-row>
        <v-col
          cols="6"
        ...
        >
          <v-hover v-slot="{ isHovering, props }">
            <v-card
              v-bind="props"
              :style="`background-color:${isHovering ? '#6f42c130' : 'white'}`"
            >
              <v-card-item>
                <div class="py-8"><span v-html="item.icon"></span></div>
...
const features = ref([
  ...
  },
  {
    ...
    text: "24/7 Customer service - We are here and happy to help ",

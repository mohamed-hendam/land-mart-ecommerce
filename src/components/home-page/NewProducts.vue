                          ...
                          <img
                            ...
                            :src="
                              showenitem[item.title]
                                ...
                                : item.thumbnail
                            "
                            :style="`width: 90%; height: 150px; cursor:pointer; transition:0.8s all ease-in-out; scale: ${
                              isHovering ? 1.05 : 1
                            }`"
                            alt=""
                            v-bind="props"
        ...
        <v-hover v-slot="{ isHovering, props }">
          <v-col cols="12" sm="12" md="4" lg="4">
            <img
              ...
              :style="`max-width: 100%; transition: 0.4s all ease-in-out; scale:${
                isHovering ? 1.05 : 1
              } `"
            />
          </v-col>
